...
const {
  ...
  authShareTokenRouter,
} = require("restLayer");

app.use("", userRouter);
app.use("", userGroupRouter);
app.use("", userGroupMemberRouter);
app.use("", authShareTokenRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "librarymanagementsystem-auth-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="librarymanagementsystem-auth-postman-collection.json"',
  );
