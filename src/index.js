...
console.log("Starting librarymanagementsystem-auth-service service...");
...
const LibrarymanagementsystemLoginSession = require("./project-session/librarymanagementsystem-login-session");

let processActive = false;
let expressServer = null;

const start = async () => {
  process.title = "node-librarymanagementsystem-auth-service";
  ...
  try {
    ...
    await setRedisData(
      "librarymanagementsystem-auth-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key librarymanagementsystem-auth-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "librarymanagementsystem-auth-service is listening HTTP/REST port " +
  ...
  // init login database
  const loginSession = new LibrarymanagementsystemLoginSession();
...
/* starting the server librarymanagementsystem-auth-service .... */
start();
